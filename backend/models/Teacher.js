...
class Teacher {
    static async create(teacherData) {
        const query = `
            INSERT INTO teachers (
                ...
                expected_hourly_rate, languages, bio, agree_terms, is_verified
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
    ...
    static async getAll() {
        const query = `
            SELECT id, first_name, last_name, email, phone, city,
                ...
                teaching_mode, is_verified, created_at
            FROM teachers
        `;
    ...
    static async update(id, teacherData) {
        ...
        const values = [
            ...
            JSON.stringify(teacherData.languages || []),
            teacherData.bio,
            teacherData.is_verified !== undefined ? teacherData.is_verified : true,
            id
        ];
